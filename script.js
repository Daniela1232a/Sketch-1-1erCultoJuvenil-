...
createSoundButton('RELOJ', '13RELOJAPURADO.mp3', 'u');
createSoundButton('TECLADO', '14TECLADORAPIDO.mp3', 'i');
createSoundButton('JEFE', '15JEFEENFADADO.mp3', 'o');
createSoundButton('GOLPE MESA', '16GOLPEMESA.mp3', 'p');
createSoundButton('HOJA ROTA', '17HOJAROTA.mp3', 'a');
createSoundButton('SUSPIRO DE ESTRES', '18SUSPIROESTRES.mp3', 's');
createSoundButton('LATIDO', 'LATIDO.mp3', 'd');
createSoundButton('SALUDO', '22.1SALUDO.mp3', 'f');
createSoundButton('VIBRACION', '23VIBRACION.mp3', 'g');
createSoundButton('LLAMADA', '24.1HABLARLLAMADA.mp3', 'h');
createSoundButton('TRISTE', '24.1SAD.mp3', 'j');
createSoundButton('TWITTER', '26TWITTER.mp3', 'k');
createSoundButton('NOTIFICACION', '27NOTIFICACION.mp3', 'l');
createSoundButton('RONQUIDO', '28RONQUIDO.mp3', 'z');
