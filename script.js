...
createSoundButton('PASOS', '25PASOS.mp3', 'vc');
createSoundButton('TWITTER', '26TWITTER.mp3', 'b');
createSoundButton('NOTIFICACION', '27NOTIFICACION.mp3', 'n');
createSoundButton('RONQUIDO', '28RONQUIDO.mp3', 'm');
