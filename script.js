...
createSoundButton('VIBRACION', '23VIBRACION.mp3', 'l');
createSoundButton('CONVERSACION CELULAR', '24CONVERSACION.mp3', 'z');
createSoundButton('LLAMADA', '24.1HABLARLLAMADA.mp3', 'x');
createSoundButton('PASOS', '25PASOS.mp3', 'c');
createSoundButton('TWITTER', '26TWITTER.mp3', 'v');
createSoundButton('NOTIFICACION', '27NOTIFICACION.mp3', 'b');
createSoundButton('RONQUIDO', '28RONQUIDO.mp3', 'n');
